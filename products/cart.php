...
$orderedProducts = $conn->query("SELECT * FROM cart WHERE user_id='$_SESSION[user_id]'");
$orderedProducts->execute();
$Allproducts = $orderedProducts->fetchAll(PDO::FETCH_OBJ);
                                ...
                                <tbody>
                                    <?php if(count($Allproducts) > 0) :?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button value="<?php echo $product->pro_id;?>" class="btn-update btn btn-primary">UPDATE</button>
                                            </td>
                                            <td class="subtotal_price">
                                            <?php echo $product->pro_price * $product->pro_qty;?>
                                            </td>
                                            <td>
                                                <button value="<?php echo $product->pro_id;?>" href="javasript:void" class="btn-delete btn-primary">Delete</i></button>
                                            </td>
                                        </tr>
                                        <?php endforeach;?>
                                    <?php else :?>
                                            <div class = "alert alert-success bg-success text-white text-center">
                                                No oredered products
