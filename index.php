...
$Allcateg = $Categories->fetchAll(PDO::FETCH_OBJ);
    ...
    <div id="page-content" class="page-content">
        ...
        <section id="categories" class="pb-0 gray-bg">
            ...
            <div class="landing-categories owl-carousel">
                <?php foreach($Allcateg as $categ) : ?>
                <div class="item">
                    <div class="card rounded-0 border-0 text-center">
                        <img src="assets/img/<?php echo $categ->image; ?>">
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                            <!-- <h4 class="card-title">Vegetables</h4> -->
                            <a href="shop.php" class="btn btn-primary btn-lg"><?php echo $categ->name; ?></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
